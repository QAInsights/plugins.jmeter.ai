...
**How to install:** Head to [https://jmeter-plugins.org/install/Install/](https://jmeter-plugins.org/install/Install/) and install the Plugins Manager. Then search for "Throughput Shaping Timer" under Available Plugins.
